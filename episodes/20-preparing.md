...
- checkpoints - places where you have planned to stop to check-in with learners. Checkpoints are especially useful at the beginning of a lesson when you may not have as many exercises but the learners need to have the data downloaded or tool opened to be able to follow along.
