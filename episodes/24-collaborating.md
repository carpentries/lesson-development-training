...
Meeting minutes are a useful way of providing a permanent record of the purpose of a meeting and what was talked about, including any decisions made or actions taken, that can be referred back to for any follow-ups. Recording meeting minutes does not have to be hard - remember that you are part of a team and there are many platforms that allow collaborative note taking. The Carpentries provide [CodiMD](https://codimd.carpentries.org/) and [Etherpad](https://pad.carpentries.org/) instances as two options for taking shared notes, widely used at Carpentries workshops for sharing pieces of code, references and notes between insturcors and learners. For some advice on holding effective meetings, see the [“Meetings, meetings, meetings”](http://teachtogether.tech/en/index.html#s:meetings) section of [Teaching Tech Together](http://teachtogether.tech/en/index.html) by Greg Wilson.
