...
- **reflections** at the end of a session to help process what was learned, for example:
    - asking learners to write down things they learned, things they want to know more about and any questions they still have or using a specific worksheet or journal for learners to summarise their thoughts about what they learned, or
    - asking learners to reflect by drawing or labelling a concept map or a diagram or writing down a list of new concepts and skills they’ve learned and (optionally) how they relate to one another or connect with previous knowledge.
