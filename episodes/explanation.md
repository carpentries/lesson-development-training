...
- usage of different terms or notations with the same meaning interchangeably without explanation, e.g. using the terms "shell", "bash", "terminal" and "console" to describe the command line interface, or "variables" and "columns" for column headings in data tables
